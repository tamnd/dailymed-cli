---
title: "dailymed"
description: "Fetch FDA drug label (SPL) data from DailyMed"
heroTitle: "dailymed, from the command line"
heroLead: "Fetch FDA drug label (SPL) data from DailyMed One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
dailymed links <path>           # the pages it links to, each addressable
dailymed serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading dailymed by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address dailymed as
  `dailymed://` URIs and follow links across sites. See
